  ...
  return (
    <main className="min-h-screen p-4 md:p-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-terminal-panel via-terminal-bg to-terminal-bg">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Footer */}
        <footer className="mt-16 pt-8 border-t border-terminal-border/50">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              {/* Contribute */}
              <div>
                <h3 className="text-terminal-text font-semibold mb-4 text-sm uppercase tracking-wider">Contribute</h3>
                <div className="space-y-2">
                  <a
                    href="https://github.com/devcodex2025/token-monitor-2"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-terminal-muted hover:text-terminal-success transition-colors text-sm"
                  >
              ...
              {/* Support project on */}
              <div>
                <h3 className="text-terminal-text font-semibold mb-4 text-sm uppercase tracking-wider">Support project on</h3>
                <div className="space-y-2">
                  <a
                    href="https://jup.ag/swap?sell=So11111111111111111111111111111111111111112&buy=AUJgYtx8hif6tWxd79hGdwiitKMxsVRrSpz8hT4uBAGS"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-terminal-muted hover:text-terminal-success transition-colors text-sm"
                  >
                  ...
                  <a
                    href="https://photon-sol.tinyastro.io/en/lp/AUJgYtx8hif6tWxd79hGdwiitKMxsVRrSpz8hT4uBAGS"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-terminal-muted hover:text-terminal-success transition-colors text-sm"
                  >
                  ...
                  <a
                    href="https://axiom.trade/t/AUJgYtx8hif6tWxd79hGdwiitKMxsVRrSpz8hT4uBAGS"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-terminal-muted hover:text-terminal-success transition-colors text-sm"
                  >
              ...
              {/* Token Monitor ($TMR) */}
              <div>
                <h3 className="text-terminal-text font-semibold mb-4 text-sm uppercase tracking-wider">Token Monitor ($TMR)</h3>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <input
                      type="text"
                      value="AUJgYtx8hif6tWxd79hGdwiitKMxsVRrSpz8hT4uBAGS"
                      readOnly
                      className="terminal-input flex-1 py-2 bg-terminal-bg/50 text-xs font-mono"
                    />
                    <button
                      onClick={() => {
                        navigator.clipboard.writeText('AUJgYtx8hif6tWxd79hGdwiitKMxsVRrSpz8hT4uBAGS');
                      }}
                      className="terminal-button-secondary px-3 py-2 text-xs whitespace-nowrap flex items-center gap-2"
                      title="Copy address"
                    >
                  ...
                  <p className="text-terminal-muted text-xs">
                    Support Token Monitor development by purchasing $TMR tokens
                  </p>
                </div>
              </div>
            </div>

            <div className="text-center text-terminal-muted text-xs pt-8">
              <p>© 2024 Token Monitor. Real-time Solana transaction tracking.</p>
            </div>
          </div>
        </footer>
      </div>
